...
data_path = 'D:/semantic segmentation/data/'
...
path = 'C:\\Users\\FGW\\Desktop\\RDAUnetcode\\raw\\file\\lr-5-32-100\\'
...
def predict():
    ...
    for i in range(imgs_test.shape[0]):
        img = resize(imgs_test[i], (128, 128,3), preserve_range=True)
        img_mask = resize(imgs_test_mask[i], (128, 128,3), preserve_range=True)
